CLASS zcl_00_sorted_hashed_it DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_00_sorted_hashed_it IMPLEMENTATION.
...
*Add 50 new connection numbers and 2000 days of flights for each
    ...
    INSERT Z00_flights FROM TABLE @insert_tab.
    out->write( |Generated { sy-dbcnt } rows in table Z00_flights| ).
